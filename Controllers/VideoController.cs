...
namespace Streamish.Controllers
{
    ...
    public class VideoController : ControllerBase
    {
        ...
        [HttpGet("GetOneVidWithComments/{id}")]
        public IActionResult GetVidComments(int id)
        {
        ...
        public IActionResult SearchByTitle(string t)
        {
            return Ok(_videoRepository.SearchTitle(t));
        }

        [HttpGet("hottest")]
        public IActionResult SearchByDate(DateTime d)
        {
            return Ok(_videoRepository.SearchByDate(d));
        }
    }
}