    ...
    public class VideoRepository : BaseRepository, IVideoRepository
    {
        ...
        public Video GetById(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                          SELECT Video.Title, Video.Description, Video.Url, Video.DateCreated AS VideoDateCreated, UserProfileId, UserProfile.Name, UserProfile.Email, UserProfile.ImageUrl, UserProfile.DateCreated AS UpDateCreated, UserProfile.ID AS UpId
                            FROM Video
                            JOIN UserProfile ON Video.UserProfileId = UserProfile.Id
                            WHERE Video.Id = @Id";
        ...
        public Video GetVideoByIdWithComments(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                          SELECT Video.Id, Video.Title, Video.Description, Video.Url, Video.DateCreated AS VideoDateCreated, Comment.Message, Comment.VideoId, Comment.Id AS CommentId
                            FROM Video
        ...
        public List<Video> SearchTitle(string title)
        {
            using (var conn = Connection)
            {
                conn.Open();
        ...
        public List<Video> SearchByDate(DateTime date)
        {
            using (var conn = Connection)
            {
                conn.Open();
